...
@Mod(modid = Tags.MOD_ID, name = Tags.MOD_NAME, version = Tags.VERSION, guiFactory = "ivorius.reccomplex.gui.RCConfigGuiFactory",
...
public class RecurrentComplex
{
    ...
    {
        return isLite() || mods.containsKey(Tags.MOD_ID); // If Lite, it's considered server-side only
    }
    ...
    public void preInit(FMLPreInitializationEvent event)
    {
        ...
        NetworkRegistry.INSTANCE.registry().get(Loader.instance().getIndexedModList().get(Tags.MOD_ID)).testVanillaAcceptance();
        ...
        cremapper = new FMLRemapperConvenience(Tags.MOD_ID, specialRegistry, remapper);
        ...
        IvGuiRegistry.INSTANCE.register(Tags.MOD_ID, guiHandler);

        communicationHandler = new RCCommunicationHandler(logger, Tags.MOD_ID, instance);
